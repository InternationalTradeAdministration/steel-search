...
describe('components', () => {
  describe('PartnerCountryBar', () => {
    ...
    it('should render the footnote', () => {
      ...
      expect(footnote.text()).toBe('Source: U.S. Department of Commerce, Enforcement and Compliance.  Includes content supplied by IHS Global Ltd.; Copyright © IHS Global, Ltd. All rights reserved.  Updated on 09-14-2017.  Product groups are sorted by most recent time period.');
    });
  });
});